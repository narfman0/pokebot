...
Func _ImageSearchArea($findImage, $resultPosition, $x1, $y1, $right, $bottom, ByRef $x, ByRef $y, $tolerance, $HBMP=0)
    ...
    $dllName = (@OSArch = "X86") ? "ImageSearch32.dll" : "ImageSearch64.dll"
    $findImageType = (IsString($findImage)) ? "str" : "ptr"
    $result = DllCall($dllName,"str","ImageSearch","int",$x1,"int",$y1,"int",$right,"int",$bottom,$findImageType,$findImage,"ptr",$HBMP)
